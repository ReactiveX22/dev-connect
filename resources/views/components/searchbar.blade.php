...
<div class="group flex items-center">
    ...
    <div id="submitDiv"
        class="flex h-full cursor-pointer rounded-r-xl border-y border-r border-zinc-800 bg-zinc-900 p-3 text-zinc-500 transition-all duration-500 group-hover:text-primary-500 group-hover:shadow-sm group-hover:shadow-primary-500 peer-focus:text-primary-500 peer-focus:shadow-sm peer-focus:shadow-primary-500">
